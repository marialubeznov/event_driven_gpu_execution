...
////////////////////////////////////////////////////////////////////////////////
int
backprop_old_main( int argc, char** argv)
{
	setup(argc, argv);
}
...
void bpnn_train_cuda(BPNN *net, float *eo, float *eh)
{
  ...
  bpnn_layerforward_CUDA<<< grid, threads, 0, stream >>>(input_cuda,
	                                          output_hidden_cuda,
											  input_hidden_cuda,
											  hidden_partial_sum,
											  in,
											  hid);
printf("Launched bpnn_layerfprward kernel \n");
  ...
  bpnn_adjust_weights_cuda<<< grid, threads, 0, stream >>>(hidden_delta_cuda,
												hid,
												input_cuda,
												in,
												input_hidden_cuda,
...
printf("Launched adjust weight kernel \n");
